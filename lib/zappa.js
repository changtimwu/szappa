...
(function() {
  ...
  zappa.app = function(func) {
    var app, client, context, helpers, io, postrenders, replace_partials, route, verb, ws_handlers, zappa_used, _fn, _i, _len, _ref;
    context = {
      id: uuid(),
      zappa: zappa,
      express: express
    ...
    app.register('.html', {
      compile: function(str, options) {
        return function(locals) {
          ...
          return replace_partials(str, this.options.partial);
        };
      }
    });
