(function() {
  var codename, coffeecup, coffeescript_helpers, copy_data_to, express, fs, jquery, jsdom, log, minify, path, sammy, socketio, uglify, uuid, viewhelpers, views, zappa,
  ...
  zappa.app = function(func) {
    ...
    context.viewhelper = function(obj) {
      var k, v, _results;
      _results = [];
      for (k in obj) {
        v = obj[k];
        _results.push(viewhelpers[k] = v);
      }
      return _results;
    };
          ...
          return function(req, res, next) {
            ...
            if (req.method.toUpperCase() !== 'GET') {
              ...
              switch (req.url) {
                ...
                case '/zappa/sammy.js':
                  return send(sammy);
                case '/zappa/coffeecup.js':
                  return send(coffeecup);
                default:
                  return next();
              }
            }
  ...
  zappa.adapter = function(engine, options) {
    ...
    return {
      compile: function(template, data) {
        if (data.hardcode == null) data.hardcode = viewhelpers;
